  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        <p className="grow text-title-small-strong text-foreground-neutral-default">
          {title}
        </p>
        <p className="line-clamp-2 grow text-body-large-default text-foreground-neutral-subtle">
          {description}
        </p>
      </div>
    </a>
