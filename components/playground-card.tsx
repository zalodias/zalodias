      ...
      <div className="absolute inset-x-4 bottom-4 z-20 flex items-end justify-between">
        ...
        {restart && (
          <button
            ...
            className="bg-background-neutral-default text-foreground-neutral-faded hover:text-foreground-neutral-default border-border-neutral-faded group absolute -right-2 -bottom-2 cursor-pointer rounded-lg border p-2 transition active:scale-95"
          >
            <RotateCw
